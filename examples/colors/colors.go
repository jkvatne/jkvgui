...
func setDefault() {
	theme.SetPallete(true, 0x5750C4, 0x925B51, 0x79747E, 0xAF1515)
}

func setPalett1() {
	theme.SetPallete(true, 0x67622E, 0x27622E, 0x1D5D7D, 0xAF1515)
}

func setPalett2() {
	theme.SetPallete(true, 0x17624E, 0x27624E, 0x1D4D7D, 0xAF1515)
}

func setPalett3() {
	theme.SetPallete(true, 0x27624E, 0x15625E, 0x1D1D7D, 0xBF0000)
}
...
func form2() wid.Wid {
	...
	return wid.Col(nil,
		...
		wid.Row(nil,
			wid.Btn("Set default", nil, setDefault, nil, "Set the default pallete on all widgets"),
			wid.Btn("Set palette 1", nil, setPalett1, nil, "Use a pallete 1"),
			wid.Btn("Set palette 2", nil, setPalett2, nil, "Select pallete nr 2"),
			wid.Btn("Set palette 3", nil, setPalett3, nil, "Select pallete nr. 3"),
			wid.Btn(cr, nil, setColorsRoles, nil, "Change between showing color tones and role pallete"),
