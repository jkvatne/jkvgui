...
var (
	...
	MainStatus   string
	BackupStatus string
	freq         = [5]float32{math.MaxFloat32, math.MaxFloat32, math.MaxFloat32, math.MaxFloat32, math.MaxFloat32}
	ad           = [6]float32{math.MaxFloat32, math.MaxFloat32, math.MaxFloat32, math.MaxFloat32, math.MaxFloat32, math.MaxFloat32}
	t            = [6]int{math.MinInt, math.MinInt, math.MinInt, math.MinInt, math.MinInt, math.MinInt}
)
...
func epsForm() wid.Wid {
	...
	return wid.Col(nil,
		...
		wid.Separator(0, 1.0, theme.OnSurface),
		/*				wid.Row(nil,
						wid.Label("Measured speed [Hz]", nil),
						wid.Label("Internal measurements", nil),
						wid.Label("Internal timers", nil),
						...
						wid.Row(nil,
							wid.Col(nil,
								...
								// wid.Separator(th, 0, wid.Pads(16)),
