...
func main() {
	window := gpu.InitWindow(2508, 1270, "Rounded rectangle demo", 1, gpu.White)
	defer gpu.Shutdown()

	for !window.ShouldClose() {
		gpu.StartFrame()
		gpu.RoundedRect(300, 50, 100, 100, 10, 2, gpu.Lightgrey, gpu.Blue)
		gpu.Fonts[2].Printf(50, 100, 24, "24 Roboto100")
		gpu.Fonts[3].Printf(50, 130, 24, "24 Roboto200")
		gpu.Fonts[4].Printf(50, 160, 24, "24 Roboto300")
		gpu.Fonts[5].Printf(50, 190, 24, "24 Roboto400")
		gpu.Fonts[0].Printf(50, 220, 24, "24 Roboto500")
		gpu.Fonts[6].Printf(50, 250, 24, "24 Roboto600")
		gpu.Fonts[1].Printf(50, 280, 24, "24 Roboto700")
